"""
Django settings for JVH project.
...
SECRET_KEY = 'django-insecure-9!v=i&8=1kz)49eb970mel_w0d7ncme17h&oj@)6e*i-ptrt#8'
...
WSGI_APPLICATION = 'JVH.wsgi.application'
...
# Lägg till dessa inställningar för login/logout
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'
LOGIN_URL = 'login'
